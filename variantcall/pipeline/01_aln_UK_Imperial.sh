#!/usr/bin/bash
#SBATCH --mem 24G --ntasks 8 --nodes 1 -J alnImperialAfum
#SBATCH --out logs/UK_Imperial.%a.log --time 8:00:00
...
mkdir -p $TOPOUTDIR
SAMPFILE=UK_Imperial_samples.csv
