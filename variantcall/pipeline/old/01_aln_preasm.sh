#!/usr/bin/bash
#SBATCH --mem 24G --ntasks 8 --nodes 1 -J preasm
#SBATCH --out logs/preasm_aln.%a.log --time 8:00:00
...
IFS=,
tail -n +2 $SAMPFILE | sed -n ${N}p | while read STRAIN LEFT RIGHT
do
    PAIR1=$INDIR/$LEFT
    PAIR2=$INDIR/$RIGHT
    echo "$PAIR1 $PAIR2"
